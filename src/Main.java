public class Main {
     ...
     */
        ...
        System.out.println();
        System.out.println("Ежемесячный платеж при ежемесячной ставке 9,99% и сроке кредита 2 года: " + (service.calculate(1_000_000, 9.99, 24)) + " руб.");

        System.out.println();
        System.out.println("Ежемесячный платеж при ежемесячной ставке 9,99% и сроке кредита 3 года: " + (service.calculate(1_000_000, 9.99, 36)) + " руб.");
